...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        'service_1556top', // Service ID
        'template_96dkffs', // Template ID
        {
          name: formData.name,
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3 p-3 bg-terminal-hover rounded border border-terminal-border">
              ...
              <div>
                ...
                <div className="text-terminal-muted text-sm">ndegeezra05@gmail.com</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-3 bg-terminal-hover rounded border border-terminal-border">
              ...
              <div>
                ...
                <div className="text-terminal-muted text-sm">+254 712 310 100</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-3 bg-terminal-hover rounded border border-terminal-border">
              ...
              <div>
                ...
                <div className="text-terminal-muted text-sm">Maseno-Kisumu </div>
              </div>
            </div>
          </div>
